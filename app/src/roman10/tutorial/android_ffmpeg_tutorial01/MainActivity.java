...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			Process p = Runtime.getRuntime().exec("/data/data/roman10.tutorial.android_ffmpeg_tutorial01/files/ffmpeg -i "+FRAME_DUMP_FOLDER_PATH+"/1.mp4 "+ FRAME_DUMP_FOLDER_PATH +"/test.mp4");
		} catch (IOException e) {
			e.printStackTrace();
		}
